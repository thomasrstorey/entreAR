...
include $(CLEAR_VARS)
ARTOOLKIT_DIR := $(MY_LOCAL_PATH)/../../../SDKs/ARToolKit5-bin-5.3.1-Android/android
...
LOCAL_MODULE    := entreARNative
LOCAL_SRC_FILES := entreAR.cpp ARMarkerNFT.c trackingSub.c
